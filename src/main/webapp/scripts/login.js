...
function passwordHint() {
	if ($("#j_username").val().length == 0) {
		...
		location.href = "${pageContext.request.contextPath}/passwordHint/"
				+ $("#j_username").val();
	}
}

function required() {
	this.aa = new Array("j_username", usernameRequired, new Function("varName",
			" return this[varName];"));
	this.ab = new Array("j_password", passwordRequired, new Function("varName",
			" return this[varName];"));
}
// ]]>
// </script>
