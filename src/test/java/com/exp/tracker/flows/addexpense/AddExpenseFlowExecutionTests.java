...
public class AddExpenseFlowExecutionTests extends AbstractXmlFlowExecutionTests
{
            ...
            FlowDefinitionResourceFactory resourceFactory)
    {
        return resourceFactory
                .createFileResource("src/main/webapp/WEB-INF/flows/addexpense/addexpense-flow.xml");
    ...
    public void testEnterExpenseDetails_Next()
    {
        setCurrentState("enterExpenseDetail");
        getFlowScope().put("expenseDetail", createTestExpenseDetail());
        getFlowScope().put("userShares", createTestExpenseDetail().getUserShares());
        MockExternalContext context = new MockExternalContext();
    ...
    public void testReviewExpense_SaveExpense()
    {
        ...
        EasyMock.expect(expenseService.saveExpense(expenseDetail))
